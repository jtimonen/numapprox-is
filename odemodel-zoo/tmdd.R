...
k_par <- list(
  stan_param(stan_var("k_on", lower = 0), "log_normal(-1, 0.3)"),
  stan_param(stan_var("k_off", lower = 0), "log_normal(0, 0.3)"),
  stan_param(stan_var("k_in", lower = 0), "log_normal(0, 0.3)"),
  stan_param(stan_var("k_out", lower = 0), "log_normal(0, 0.3)"),
  stan_param(stan_var("k_eL", lower = 0), "log_normal(-1, 0.3)"),
  stan_param(stan_var("k_eP", lower = 0), "log_normal(-3, 0.3)")
)
